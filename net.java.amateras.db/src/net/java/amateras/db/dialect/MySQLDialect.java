...
public class MySQLDialect extends AbstractDialect {
	...
	private static final IColumnType[] COLUMN_TYPES = {
		...
		new ColumnType("NUMERIC", Messages.getResourceString("type.real"), true, Types.DECIMAL),
		...
		new ColumnType("DATETIME", Messages.getResourceString("type.datetime"), true, Types.DATE),
